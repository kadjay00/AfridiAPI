...
@Entity('T_MOVEMENT_TEMP', {schema: 'dbo' } )
@Index('IX_MOVEMENT_TEMP_APPL', ['MVT_APPLICATIONDATE_DAT', 'MVT_TREATEDDATE_DAT', 'MVT_ASAPNIGHT_C', 'MVT_IDNUMBER_C', 'MVT_EANCODE_N', 'MVT_CREATIONDATE_DAT'])
export class T_MOVEMENT_TEMP {
