...
export class T_PDC {
    ...
    public PDC_INUSEBY_C: string | null;
    ...
    @Column('datetime', {
        nullable: true,
        name: 'PDC_INUSEBYDATE_DAT',
        })
    public PDC_INUSEBYDATE_DAT: Date | null;

    @Column('varchar', {
        nullable: true,
        length: 20,
        name: 'PDC_INUSEBYPDT_C',
        })
    public PDC_INUSEBYPDT_C: string | null;
    ...
    public PDC_LISSAGE_C: string | null;
